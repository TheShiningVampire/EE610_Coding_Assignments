...
"color: rgb(0, 0, 0);")
        ...
        self.kernel.valueChanged.connect(self.KERNEL_SIZE)                             # Connect slider to Kernel Size function
    ...
    def KERNEL_SIZE(self):
        """
        Function to get kernel size for Gaussian Blur
        """
        self.kernel_size = int(self.kernel.value())
    ...
    def BLUR_IMAGE(self):
        ...
        img_output = GaussianBlur(image, self.kernel_size, sigma)       # Perform blurring on the image
